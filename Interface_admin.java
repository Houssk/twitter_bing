...
public class Interface_admin extends JFrame{
	...
	bande_sup.setLayout(bande_supLayout);
	       ...
	       //JLabel titreOnglet2 = new JLabel("Sauvegarde");
	       ...
	       bande_sup.setBackground(new Color(64,153,255));
	        ...
	        deconnexion.addActionListener(new ActionListener() {
	            public void actionPerformed(ActionEvent evt) {
	            	...
	            	f.validate();
	            	t.stop();
	            	System.out.println("statut"+t.getState());
	            }
	        });
			...
			JButton gestion = new JButton("Gestion");
			gestion.setPreferredSize(new Dimension(110, 30));
			JButton sauvegarder = new JButton("Sauvegarder");
			sauvegarder.setPreferredSize(new Dimension(150, 30));
			gestion.addActionListener(new ActionListener() {
	            public void actionPerformed(ActionEvent evt) {
	            	try {
						Interface_gestion f=new Interface_gestion();
			...
			MouseListener doubleclicNews = new MouseAdapter() 
        {
		    ...
		    pack();
		    f.setTitle("Bienvenue Bob sur votre session");
			f.setVisible(true);	
